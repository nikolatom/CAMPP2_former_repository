...
authors:
  ...
  email: nikto@cancer.dk, tiberti@cancer.dk, elpap@dtu.dk, elenap@cancer.dk
package: CAMPP2
output:
...
10 feature counts from example batch corrected data are used as an input. PlotDistributions(campp2_brca_1_batchCorrected[1:10,], campp2_brca_1_distributionsFit)
```
\
...
6) a matrix ccontaining accuracy and 95 percent confidence interval for predictions 
