...
runCampp2(batches=c("tumor_stage","tumor_stage"),prefix="test_CAMPP2", data1=campp2_brca_1, data2=campp2_brca_2, metadata1=campp2_brca_1_meta, 
metadata2=campp2_brca_2_meta, groups=c("IDs", "diagnosis","IDs", "diagnosis"), technology=c("seq","seq"))
...
###A example code for batch correction
...
runCampp2(prefix="Testing_DEA", data1=campp2_brca_1, metadata1=campp2_brca_1_meta, groups=c("IDs", "diagnosis"), technology=c("seq"), 
block=campp2_brca_1_meta$tumor_stage)

###An example code for running differential expression analysis with visualizations
runCampp2(prefix="Testing_DEA_visuals", data1=campp2_brca_1, metadata1=campp
