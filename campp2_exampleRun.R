...
#runCampp2(prefix="TestBlocking", data1=dataset1, data2=dataset2, metadata1=metadata1,metadata2=metadata2, groups=c("IDs", "diagnosis","IDs", "diagnosis"), technology=c("seq","seq"), block=block)
runCampp2(prefix="TESTEST", data1=dataset1, metadata1=metadata1, groups=c("IDs", "diagnosis"), technology=c("seq"), block=c(metadata1$tumor_stage))
