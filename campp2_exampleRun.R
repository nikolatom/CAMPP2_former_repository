...
runCampp2(prefix="Testing_DEA", data1=campp2_brca_1, metadata1=campp2_brca_1_meta, groups=c("IDs", "subtype"), technology=c("seq"), block=c(metadata1$subtype), plot.DEA=TRUE, plot.heatmap="DEA")
