...
#' Forest_Features function which is used to fit random forest model
#' to the data and to perform feature selection using random forest.
#' Data were generated by running:
#' campp2_brca_1_forest_features <- Forest_Features(seed = 173,
#' data = campp2_brca_1,
...
#'
#' This object represents output from the
#' RF_Apply function which is used to run the Forest_Features function
#' across seeds.
#' Data were generated by running:
