...
#' @param num.km.clusters a vector of manually defined number(s) of clusters. This vector represent a number of groups, sub types, etc. expected in the data. If multiple values provided, the function will automatically perform K-means clustering based on each (expected number of clusters) of them separately. By default, possible numbers of clusters are calculated automatically based on BIC (mclust package) applied to sub sampled data. A default value for this parameter is NULL.
...
runCampp2 <- function (data1, metadata1, data2=NULL, metadata2=NULL, technology, groups, batches=NULL, data.check=TRUE, standardize=FALSE, transform=FALSE, plot.PCA=FALSE, plot.heatmap=FALSE, kmeans=FALSE, num.km.clusters=NULL, signif=NULL, block=NULL, colors=NULL, prefix="Results", correlation=FALSE, lasso=FALSE, WGCNA=FALSE, cutoff.WGCNA=NULL, survival=FALSE, covariates=NULL, stratify=NULL, surv.plot=50, PPint=FALSE, gene.miR.int=FALSE, show.PCA.labels=FALSE){
    ...
    c(data1,data2,metadata1,metadata2,technology,groups,
      ...
      show.PCA.labels) %<-% parseArguments(data1=data1, metadata1=metadata1, data2=data2, metadata2=metadata2,
