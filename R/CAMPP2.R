...
#' @param plot.PCA Argument specifies ("TRUE" or "FALSE") if a PCA plot (describing relationships between the samples based on feature counts and sample groups; generated by PCAPlot function) should be made for data overview. Default is FALSE (do not run).
...
#' @param plot.umap This argument specifies ("TRUE" or "FALSE") if a UMAP plot (based on feature counts and sample groups) should be made for data overview. Default is FALSE (do not run).
#' @import zeallot
#' @import M3C
#' @export
#' @seealso
...
runCampp2 <- function (data1, metadata1, data2=NULL, metadata2=NULL, technology, groups, batches=NULL, data.check=TRUE, standardize=FALSE, transform=FALSE, plot.PCA=FALSE, plot.heatmap=FALSE, kmeans=FALSE, num.km.clusters=NULL, signif=NULL, block=NULL, colors=NULL, prefix="Results", correlation=FALSE, lasso=FALSE, WGCNA=FALSE, cutoff.WGCNA=NULL, survival=FALSE, covariates=NULL, stratify=NULL, surv.plot=50, PPint=FALSE, gene.miR.int=FALSE, show.PCA.labels="none",plot.umap=FALSE){
    ...
    c(data1,data2,metadata1,metadata2,technology,groups,
      ...
      show.PCA.labels,plot.umap) %<-% parseArguments(data1=data1, metadata1=metadata1, data2=data2, metadata2=metadata2,
                                                ...
                                                PPint=PPint, gene.miR.int=gene.miR.int, show.PCA.labels=show.PCA.labels,plot.umap=plot.umap,
