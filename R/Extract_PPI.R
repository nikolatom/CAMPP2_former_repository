#' @title Extract the protein-protein interactions
#' @description Function which extracts the protein-protein interactions where each protein (gene) is differentially abundant (expressed).
#' @param my.DB a output of the function "DownloadPPInt", e.g. a curated string database.
