...
#' @description A function for re-formating the output from DEA generated based
#' on the
#' workflow: (runDEA - DEAFeatureApply - DEAFeature - limma); and exporting
#' the results into a .txt file.
