...
\
**Parameters:** \
*data* a raw feature count matrix from "seq", "array", "ms" or "other"
...
contrast of two groups). Cutoffs for logFC and FDR, and blocking variable are
optional. \
\
**Parameters:** \
*contrast.matrix* an array containing contrast.matrix between groups of
...
\
**An example run:** \
##Create an Upset plot based on a list of the features characteristic for each 
group
```
...
prefix="test_heatmap", viridis.opt = "turbo", data.type = "Feature counts")
